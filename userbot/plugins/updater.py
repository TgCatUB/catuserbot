...
@register(outgoing=True, pattern="^.update2(?: |$)(.*)")
async def upstream(ups):
    "For .update command, check if the bot is up to date, update if specified"
    await ups.edit("`Checking for updates, please wait....`")
    conf = ups.pattern_match.group(1).lower()
    off_repo = 'https://github.com/sandeepn1709/userbot.git'
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/sandy1709/userbot"
...
@borg.on(admin_cmd("update1 ?(.*)", outgoing=True))
