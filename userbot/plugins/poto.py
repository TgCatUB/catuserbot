...
@catub.cat_cmd(
    ...
    info={
        ...
        "description": "Reply to user to get his profile pic use command along \
            with profile pic number to get desired pic else use .poto all to get \
            all if you dont reply then gets group pics. If you dont reply to any one \
            then will get chat profile pic.",
        "usage": [
            "{tr}poto <number>",
            "{tr}poto all",
            "{tr}poto",
