...
async def corona(event):
    ...
    if country_data:
        ...
        await catevent.edit("<b>Corona Virus Info of {}:\n{}</b>".format(country, data), parse_mode='html')
    else:
        ...
        if data:
            ...
            await catevent.edit("<b>Corona Virus Info of {} is not avaiable or unable to fetch</b>".format(country), parse_mode='html')
