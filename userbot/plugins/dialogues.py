...
collection = [
    ...
    ["…namukku chodichu chodichu pokaam. Namukku chodichu chodichu chodichu pokam.","Ayal Kadha Ezhuthukayanu"],
    ["Case Kodukkanam Pillecha!","Meesha Madhavan"],
    ["Ninney thookkaan ividathe niyamathinu bhayam aayirunnu… marikkaan ninakkum. Pakshe ithinu randinum Mannadiyarku bhayamilla.","Dhruvam"],
    ...
    ["Njan ee polytechnic’il onnum poyittillallo. Athukondee yanthrathinte pravarthanonnum enikku nishchayilla. Angana sambhavichatha.","Thalayana Manthram"],
    ...
    ["Njan oru thevidisshy ayathintey mahathwam ippozhaanenikku manasilayathu!","Avalude Ravukal"],
    ["Adichu mole!","Kilukkam"],
    ["Orikkalum oru SSLC’karan oru Degree’karaney vedhanippikkarauthu.","Nadodikkattu"],
    ["Ormayundo ee mugham?","Commissioner"],
    ["Kittiya Ootty, allenkil chatti!","Kilukkam"],
    ["Pempillerey roattikoodey nadakkaan nee sammathikkilla, alley?... Da, neeyaanee alavaladi Shaji alley?","Lisa"],
    ["Athu enne uddheshichanu… enne thanney uddheshichanu… enne maatram uddheshichanu!","C.I.D. Moosa"],
    ["Varkkicha… yevan puliyanu ketta. Puliyennu paranja verum puli alla… oru simham!","Rajamanikyam"],
    ["Raju mon orikkal ennodu chodichu, uncle’intey father aaraannu.","Rajavinte Makan"],
    ...
    ["Marakkano? Pazhayathokke njan marakkano? Enthokkeyado njan marakendathu?","Godfather"],
    ...
    ["Chanduviney tholpikkaan ningalkavilla. Jeevitathil Chanduviney tholpichittundu… palarum… palavattom…","Oru Vadakkan Veeragatha"],
    ...
    ["Alla... ithaara? Varyampalliley Meenakshi alleyo? Entha moley scooter'lu!","Manichitrathazhu"],
    ["Ente bheeshaneennu paranjaal, kanda oochali raashtriyakkare koottu sthalam maatti kalayoonnonnum aavilla… konnu kalayum njan!","Devasuram"],
    ["Njan Thiruvanathapurathekku onnu vilikkam.","Meesha Madhavan"],
    ["Kolothey thambrattiyado… mashe!","Aaraam Thampuran"],
    ["Oru manoroga chikilsakanum sancharichittillatha vazhikaliloodey okke njan sanjarichennirikkum… Oru bhrathaney pole.","Manichitrathazhu"],
    ...
    ["Theerumbo theerumbo pani tharaan njan entha kuppeennu vanna bhootha?","Punjabi House"],
    ["Sarale… Sarale… Vaathil thurakku…","Kankettu"],
    ["Athaanu Urumees!","Aadyathe Kanmani"],
    ["Ente thala, ente full-figure… Ente thala, ente full-figure… Angane… Angane… Angane…","Udayananu Tharam"],
    ...
    ["Kalangiyilla…","Yodha"],
    ["Nee ithrem bhayanakaranaya kaaryam njaan arinjilla!","Sanmanassullavarkku Samadhanam"],
    ["Thoma chettayalla.","Spadikam"],
    ["Neraa Thirumeni… Eapachan pallikudathee poyittilla…","Lelam"],
    ["Njan pinney OK’nnu paranju.","Kilukkam"],
    ["Krishnavilasom Bageerathan Pilla… valiya vedi naalu… cheriya vedi naalu…","Meesha Madhavan"],
    ...
    ["Bhoogolathintey oro spandanavum kanakkilaanu. Without mathematics, bhoomi oru vatta-poojyava!","Spadikam"],
    ["Bhavani onnu manassu vechaal… ee kalavara namukkoru maniyara aakkaam.","Kalyanaraman"],
    ...
    ["Nee adakkamulla penvargam mattarum kaanaathatu kaanum. Ningal shapichu kondu konjum, chirichu kondu karayum, mohichu kondu verukkum.","Oru Vadakkan Veeragatha"],
    ...
    ["Juice juice juice, kummatti ka juice. Mammoottykka’kishtapettta kummatti ka juice!","Maheshinte Prathikaaram"],
    ["Porathu nalla mazhayundu… Nananjalo?","Ennu Ninte Moideen"],
    ["Nee Kaanan kollavunna pen-pillerudey kaamukanmaarey kandittiley? Thani Oolanmaar aayirikkum!","Thattathin Maraythu"],
    ["Enthaannariyilla, oraalku nalla kaaryam varunnoonn’aryimbol nenjinte ividey oru vingala.","Rani Padmini"],
    ...
    ["Nee theernneda, nee theernnu! Ithrem ahankaaram padillada. Nee theernneda, nee theernnu!","Left Right Left"],
    ["Ivaleym kothippichu kadannu kalanjalo?","Amar Akbar Anthony"],
    ["Aaninu ariyathathaayi onney ullu ee bhoomiyil… athu penna.","Vettah"],
    ["Wow! Psychological move! Prathiyogikale maanasikamayi thalarthanulla neekam!","Memories"],
    ...
    ["Nee wholesale’um cheyilla, retail’um cheyilla… oru mattethum cheyilla!","Angamly Diaries"],
    ["Premathinennum pathinaaru vayassa… Valli-nikkaril ninnum otta-mundilekku kerunna prayam.","Munthirivallikal Thalirkumbol"],
    ...
    ["Angana njaan pani eduthittu Pakistan nannavanda… Bharat Mata Ki…Jai!","Kattappanayile Rithwik Roshan"],
    ...
    ["Chellu ikka… poyi idikku ikka. Avantey nilpu kandilley! Poyi idikkikka.","Annayum Rasoolum"],
    ["Ho! Ithineyokke kaanumbozha, veeti irikkunnenayokke eduthu kinattil idaan thonunnathu.","2 Countries"],
    ["Enikku enne poley aavanam, Govind… iniyenkilum. Ninakku venda enne poley alla, enikku venda enne poley.","Uyare"],
    ...
    ["Daivathinte maalakhamaar ennokke vilipere ullu, Sir. Vilikkunnavar aarum maalakhamaarudey veetiley avastha chodikkarilla.","TakeOff"],
    ["Maapu Jayan parayulla… keta? Azhi engi azhi, kayar engi kayar!","Left Right Left"],
    ["Ente idea aayipoyi… ninte idea aayirunnenkil, ninna njan konnene patti!","Maheshinte Prathikaaram"],
    ["Thaanundello… thaan oru van-dhurandhaanu!","Kohinoor"],
    ["Girls’nu athyaavashyam freedom anuvadichu kodukkunna oru modern family aanu njangadey.","Kumbalangi Nights"],
    ["Chettanu ithine patti valya dhaarana illa alley?","Maheshinte Prathikaaram"],
    ["Aarokke enthokke paranjalum… vellavum, mannum, pennum nammale nattile thanneya nallathu!","Bangalore Days"],
    ...
    ["… Scene Contra!","Premam"],
    ["Chin up…shoulder down… chin down… chin podik-up… eyes open… READY!","Maheshinte Prathikaaram"],
