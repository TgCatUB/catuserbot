...
@catub.cat_cmd(
    ...
    info={
        ...
        "usage": [
            "{tr}tl <langugage code> ; <text",
            "{tr}tl <langugage codes>",
        ],
...
@catub.cat_cmd(
    ...
    info={
        "header": "To set language for trt/ai comamnd.",
        "description": "Check here [Language codes](https://telegra.ph/Language-codes-11-01)",
        "options": {
