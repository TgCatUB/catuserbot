...
@bot.on(admin_cmd(pattern=r"glist(?: |$)(-l \d+)?(?: |$)?(.*)?(?: |$)",command = "glist", outgoing=True))
@bot.on(sudo_cmd(pattern="glist(?: |$)(-l \d+)?(?: |$)?(.*)?(?: |$)",command = "glist", allow_sudo=True))
async def catlists(gdrive):
    await lists(gdrive)


@bot.on(admin_cmd(pattern="gdf (mkdir|rm|chck) (.*)",command = "gdf (mkdir|rm|chck)", outgoing=True))
@bot.on(sudo_cmd(pattern="gdf (mkdir|rm|chck) (.*)",command = "gdf (mkdir|rm|chck)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="(gdfset|gdfclear)(?: |$)(.*)",command = "(gdfset|gdfclear)", outgoing=True))
@bot.on(sudo_cmd(pattern="(gdfset|gdfclear)(?: |$)(.*)", command = "(gdfset|gdfclear)",allow_sudo=True))
