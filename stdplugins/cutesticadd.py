...
@borg.on(admin_cmd(pattern="cadd ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    packname = f"Nagato's Cute @UniBorg Pack"
    packshortname = f"Cute_Borg_{userid}"  # format: Uni_Borg_userid

    is_a_s = is_it_animated_sticker(reply_message)
    file_ext_ns_ion = "@Uni_Borg_Sticker.png"
    ...
    await event.edit("Pirating this Cutie. Please Wait!")
    ...
    await event.edit(f"Yu ho!! This cute sticker has been Pirated! This cutie is [here](t.me/addstickers/{packshortname})")
