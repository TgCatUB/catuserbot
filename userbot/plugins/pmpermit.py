...
USER_BOT_WARN_ZERO = "You were spamming my peru (pro) master's inbox, henceforth you are blocked by my master's Bot. **Now Get Out From Here, i'm studying lol!! Bye** "
