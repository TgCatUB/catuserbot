...
async def _(event):
    ...
    if not USER_AFK:  # pylint:disable=E0602
        ...
        if reason:
            await borg.send_message(event.chat_id, f"**I shall be AFK** __because ~ {reason}__")
        else:
            await borg.send_message(event.chat_id, f"**ME NIKL....BYEE BYEE HIHIHIHIHI**")
        await asyncio.sleep(5)
        await event.delete()
        try:
            await borg.send_message(  # pylint:disable=E0602
