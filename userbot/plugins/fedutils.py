...
async def fetch_fedinfo(event):
    ...
    async with event.client.conversation(rose) as conv:
        try:
            ...
            await edit_delete(catevent,"**Error while fecthing fedinfo:**\n__Unblock__ @MissRose_Bot __and try again!__",10)
...
async def myfeds_fedinfo(event):
    ...
    async with event.client.conversation(rose) as conv:
        try:
            ...
            await edit_delete(catevent,"**Error while fecthing myfeds:**\n__Unblock__ @MissRose_Bot __and try again!__",10)
        except Exception as e:
...
async def fstat_rose(event):
    ...
    async with event.client.conversation(rose) as conv:
        try:
            ...
            await edit_delete(catevent,"**Error while fecthing fedstat:**\n__Unblock__ @MissRose_Bot __and try again!__",10)
        except Exception as e:
