...
CMD_HELP.update(
    {
        ...
        \n\n📌** CMD ➥** `.lock <all/type>`\
        \n**USAGE   ➥  **__Allows you to lock the permissions of the chat.__\
        \n\n📌** CMD ➥** `.unlock <all/type>`\
        \n**USAGE   ➥  **__Allows you to unlock the permissions of the chat.__\
        \n\n📌** CMD ➥** `.locks`\
        \n**USAGE   ➥  **__To see the active locks__\
        \n\n📌** CMD ➥** `.plock <all/type>`\
        \n**USAGE   ➥  **__Allows you to lock the permissions of the replied user in that chat.__\
        \n\n📌** CMD ➥** `.punlock <all/type>`\
        \n**USAGE   ➥  **__Allows you to unlock the permissions of the replied user in that chat.__\
        \n\n📌** CMD ➥** `.uperm <reply/username>`\
        \n**USAGE   ➥  **__Shows you the admin rights if he is admin else will show his permissions in the chat__\
