...
CMD_HELP.update(
    {
        "groupactions": "__**PLUGIN NAME :** Groupactions__\
      \n\n📌** CMD ➥** `.kickme`\
      \n**USAGE   ➥  **__Throws you away from that chat_\
      \n\n📌** CMD ➥** `.kickall`\
      \n**USAGE   ➥  **__To kick all users except admins from the chat__\
      \n\n📌** CMD ➥** `.banall`\
      \n**USAGE   ➥  **__To ban all users except admins from the chat__\
      \n\n📌** CMD ➥** `.unbanall`\
